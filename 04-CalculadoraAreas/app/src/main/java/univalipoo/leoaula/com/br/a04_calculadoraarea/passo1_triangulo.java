    ...
    public class passo1_triangulo extends AppCompatActivity {
        ...
        public void onClickAvancar(View v) {
            ...
            Intent intencaoAbrirTrianguloResultado = new Intent(this.getApplicationContext(), resultado_triangulo.class);
