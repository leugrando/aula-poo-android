...
public class passo1_circuloActivity extends AppCompatActivity {
    ...
    public void onClickAvancar(View v){
        ...
        Intent intencaoAbrirCirculoResultado = new Intent(this.getApplicationContext(), resultado_circuloActivity.class);
