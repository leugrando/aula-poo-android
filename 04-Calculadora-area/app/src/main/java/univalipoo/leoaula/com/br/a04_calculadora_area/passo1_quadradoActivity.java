...
public class passo1_quadradoActivity extends AppCompatActivity {
    ...
    public void onClickAvancar(View v){
        ...
        Intent intencaoAbrirQuadradoResultado = new Intent(this.getApplicationContext(), resultado_quadradoActivity.class);
