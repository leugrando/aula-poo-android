...
public class passo1Circulo extends AppCompatActivity {
    ...
    public void onClickAvancar(View v){
        ...
        Intent intencaoAbrirCirculoResultado = new Intent(this.getApplicationContext(), resultadoCirculoActivity.class);
